...
public class playermovement : MonoBehaviour
{
    ...
    [Header("Wall Running")]
    public bool wallrunning = false; // Added wallrunning variable
    ...
    private void Jump()
    {
        rb.velocity = new Vector3(rb.velocity.x, 0f, rb.velocity.z); // Reset the Y velocity before applying jump force
